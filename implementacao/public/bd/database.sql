...
CREATE TABLE IF NOT EXISTS `mydb`.`Vantagens` (
  `idVantagem` VARCHAR(45) NOT NULL,
  `nome` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Professor` (
  ...
  `moeda` VARCHAR(45) NULL,
  `idInstituicao` VARCHAR(45) NOT NULL,
  `Instituicao_id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Transacoes` (
  `id` INT NOT NULL,
  `Aluno_nome` CHAR NOT NULL,
  `Professor_nome` CHAR NOT NULL,
  `valor` VARCHAR(45) NOT NULL,
  `descricao` VARCHAR(45) NULL,
  PRIMARY KEY (`id`, `Aluno_nome`, `Professor_nome`),
  INDEX `fk_Transacoes_Professor_idx` (`Professor_nome` ASC) VISIBLE,
  INDEX `fk_Transacoes_Aluno1_idx` (`Aluno_nome` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Vantagens_has_Aluno` (
  `Vantagens_idVantagem` VARCHAR(45) NOT NULL,
